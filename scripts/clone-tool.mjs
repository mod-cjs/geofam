...
const BURMISTER_BRIDGE_AND_SHIM = [
  ...
  '    + "</main></body></html>";',
  '}',
  '/* Emet snapshot:capture APRES le rendu (jamais avant). displayHtml = panneau de',
  '   resultats (resout) tel qu affiche ; printHtml = document imprimable auto-contenu. */',
  ...
  '    var displayHtml=__roadsensCloneClean(resout, false);',
