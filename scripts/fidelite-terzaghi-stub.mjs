/**
 * Stub backend MINIMAL pour le spec de fidélité terzaghi (qa-test).
 *
 ...
 * SEUL besoin serveur (entitlements « actif », module terzaghi inclus).
 *
 ...
 *
 * Port dédié via env STUB_PORT (défaut 3199), distinct du next dev (3101).
 */
...
server.listen(PORT, '127.0.0.1', () => {
  ...
  console.log(`[fidelite-terzaghi-stub] écoute http://127.0.0.1:${PORT}`);
});
