...
const burmisterDescriptor: EngineDescriptor = {
  ...
  fields: [
    ...
    },
    {
      ...
      max: 60000,
      unit: 'MPa',
      hint: 'Module à la température ÉQUIVALENTE θ_éq=34 °C (référentiel AGEROUTE Sénégal) : BBSG ≈ 1512, GB3 ≈ 2588, EME2 ≈ 6151 MPa. NE PAS saisir les modules à 15 °C.',
    },
    {
      key: 'layer1_nu',
    ...
    },
    {
      ...
      max: 60000,
      unit: 'MPa',
      hint: 'Module à θ_éq=34 °C (référentiel AGEROUTE Sénégal) : GB3 ≈ 2588, EME2 ≈ 6151, GC3 ≈ 23000 MPa. NE PAS saisir les modules à 15 °C.',
    },
    {
      key: 'layer2_nu',
