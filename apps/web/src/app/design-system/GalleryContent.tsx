...
import { CommandPalette, DEMO_COMMAND_ITEMS } from '@/components/ui/CommandPalette';
...
import {
  ...
  type TableColumn,
  type TableRow,
} from '@/components/ui/OutputTable';
...
function GalleryInner() {
  return (
    ...
    >
      ...
      <main
        id="main-content"
        style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 32px' }}
      >
...
function VerdictBannerSection() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 600 }}>
      ...
      />
      <p className="label-caps" style={{ marginTop: 8 }}>
        Mode compact
      </p>
  ...
  const scale = [
    {
      token: '--text-2xl',
      px: 32,
      usage: 'Valeur de synthèse principale (plafond)',
      weight: 600,
    },
...
function ElevationDemo() {
  const levels = [
    ...
    {
      label: 'Niveau 1 — elevation-card',
      shadow: 'var(--elevation-card)',
      bg: 'var(--surface-base)',
    },
    {
      label: 'Niveau 2 — elevation-modal',
          ...
          <div key={variant}>
            ...
            >
              ...
              <Button
                variant={variant}
                size="md"
                iconLeft={<Calculator size={16} strokeWidth={1.5} />}
              >
                Avec icône
              </Button>
...
function FieldSection() {
  ...
  function validateModule(value: string) {
    ...
    if (n < 50 || n > 15000)
      return {
        warning:
          "Hors plage physique plausible (50–15 000 MPa). L'ingénieur outrepasse consciemment.",
      };
    return {};
  }
...
function MetricSection() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div>
        <p className="label-caps" style={{ marginBottom: 12 }}>
          Variante isolated (valeur phare 32px)
        </p>
      ...
      <div>
        <p className="label-caps" style={{ marginBottom: 12 }}>
          Variante table (14px 600 + unité muted)
        </p>
      ...
      <div>
        <p className="label-caps" style={{ marginBottom: 12 }}>
          {"Valeurs indisponibles (NaN / Infinity / null / undefined → '—')"}
        </p>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, alignItems: 'center' }}>
      ...
      <div>
        <p className="label-caps" style={{ marginBottom: 12 }}>
          Variante out-of-range (hors plage physique)
        </p>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      >
        <OutputTable
          ...
          error={
            status === 'error'
              ? 'Non-convergence du calcul Burmister. Vérifier la cohérence des paramètres.'
              : undefined
          }
...
function SkeletonSection() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div>
        <p className="label-caps" style={{ marginBottom: 12 }}>
          Variante liste calculs (colonne gauche 280px)
        </p>
        <div
          style={{
            width: 280,
      ...
      <div>
        <p className="label-caps" style={{ marginBottom: 12 }}>
          Variante OutputTable (dimensions réelles, CLS=0)
        </p>
        <div
          style={{
            background: 'var(--surface-base)',
    ...
    >
      {[
        ...
        >
          <p
            className="label-caps"
            style={{ padding: '12px 16px 0', color: 'var(--text-muted)' }}
          >
            Vide absolu (premier usage)
          </p>
  ...
  return (
    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          footer={
            <>
              ...
              <Button variant="action" size="sm">
                Émettre et sceller le PV n°12
              </Button>
            </>
          }
        >
          <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
            Module E1 : <Metric value={4200} unit="MPa" /> — CBR :{' '}
            <Metric value={12.5} unit="%" decimals={1} />
          </p>
          <p
            style={{
              fontSize: 13,
      ...
      <Modal
        ...
        footer={
          <Button variant="action" size="sm" onClick={() => setOpenModal(null)}>
            Fermer
          </Button>
        }
      >
        <p style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
          Vérifiez les champs et relancez.
        </p>
      </Modal>
    </div>
  );
...
const DD_ITEMS: DropdownItem[] = [
  {
    id: 'edit',
    label: 'Modifier',
    icon: <Edit2 size={16} strokeWidth={1.5} />,
  ...
  return (
    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
      <Button
        ...
        size="sm"
        onClick={() =>
          addToast({ type: 'success', message: 'PV n°12 émis et scellé avec succès.' })
        }
      >
        Succès (4s)
      </Button>
      ...
      <Button
        ...
        onClick={() =>
          addToast({
            type: 'warning',
            message:
              "Paramètres hors plage physique plausible. L'ingénieur outrepasse consciemment.",
          })
        }
      >
        Warning
      ...
      <Button
        ...
        onClick={() =>
          addToast({
            type: 'info',
            message: 'Densité compacte disponible — activer dans les paramètres.',
          })
        }
      >
        Info
...
function TooltipSection() {
  return (
    <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', alignItems: 'center' }}>
      ...
      <TooltipRich text="Lancer le calcul" shortcut={['Ctrl', 'Entrée']}>
        <Button variant="action" size="sm">
          Calculer
        </Button>
      </TooltipRich>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <p style={{ fontSize: 12, color: 'var(--text-muted)' }}>
        {
          'Sans contexte projet : "Nouveau calcul" et "Émettre un PV" absents. Les récents ne croisent jamais les orgs (à câbler par le tenant).'
        }
      </p>
      <CommandPalette
        open={open}
