...
const OUTPUT = {
  ...
  fatigueInverse: { valeur: 0.469, admissible: 0.384, ok: false, couche: 4 },
  couchesTraitees: [
    { couche: 2, mode: 'semi-collée', valeur: 0.27, admissible: 0.42, ok: true },
    { couche: 3, mode: 'semi-collée', valeur: 0.33, admissible: 0.38, ok: true },
  ],
  couchesGranulaires: [
    { couche: 2, valeur: 686.12, admissible: 511.5, ok: false },
  ],
};
